...
**0.5.0 es la descarga pública actual para Windows.** CapturePack sigue siendo un
...
CapturePack `0.5.0` es la versión de la aplicación. El `format_version` del pack
