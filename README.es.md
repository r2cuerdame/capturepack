...
Versión pública actual para Windows: **CapturePack 0.4.6**. En la versión 0.4.4,
...
**0.4.6 es la descarga pública actual para Windows.** CapturePack sigue siendo un
...
CapturePack `0.4.6` es la versión de la aplicación. El `format_version` del pack
