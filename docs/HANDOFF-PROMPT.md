...
The current public Windows release is stable `v0.6.0`, published through the
guarded Release workflow and verified against its downloaded assets. Treat the
immutable `v0.6.0` tag and its four verified assets as the release authority: do
