...
application `0.5.1-rc.1` can generate packs using newer additive format versions;
...
**Current state.** `0.5.0` is the public stable release; `main` currently carries the `0.5.1-rc.1` candidate. History
