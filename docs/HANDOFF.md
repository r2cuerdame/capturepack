...
`core/package.json` is application version `0.5.1-rc.1`; packs containing the
...
`qa:rc` currently runs 91 discovered `check:*` regressions plus type checking,
the production build, and isolated Electron smoke: **94 gate steps** — 92 with
