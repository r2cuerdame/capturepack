...
**`0.3.4-rc.30`** — a release *candidate* version so a locally built installer can
...
`core/release-rc30c/CapturePack-Setup-0.3.4-rc.30.exe`. It is unsigned and gitignored:
