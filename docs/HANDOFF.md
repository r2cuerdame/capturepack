...
**`0.3.4-rc.25`** — a release *candidate* version so a locally built installer can
...
`core/release-rc25/CapturePack-Setup-0.3.4-rc.25.exe`. It is unsigned and gitignored:
