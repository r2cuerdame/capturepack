...
**`0.3.4-rc.32`** — a release *candidate* version so a locally built installer can
...
`core/release-rc32c/CapturePack-Setup-0.3.4-rc.32.exe`. It is unsigned and gitignored:
