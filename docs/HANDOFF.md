...
**`0.3.4-rc.16`** — a release *candidate* version so a locally built installer can
...
`core/release-rc16/CapturePack-Setup-0.3.4-rc.16.exe`. It is unsigned and gitignored:
