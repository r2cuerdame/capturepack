...
**`0.3.4-rc.29`** — a release *candidate* version so a locally built installer can
...
`core/release-rc29c/CapturePack-Setup-0.3.4-rc.29.exe`. It is unsigned and gitignored:
