...
**`0.3.4-rc.28`** — a release *candidate* version so a locally built installer can
...
`core/release-rc28c/CapturePack-Setup-0.3.4-rc.28.exe`. It is unsigned and gitignored:
