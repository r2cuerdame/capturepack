...
**`0.3.4-rc.14`** — a release *candidate* version so a locally built installer can
...
`core/release-rc14/CapturePack-Setup-0.3.4-rc.14.exe`. It is unsigned and gitignored:
