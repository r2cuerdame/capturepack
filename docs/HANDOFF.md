...
**`0.3.4-rc.26`** — a release *candidate* version so a locally built installer can
...
`core/release-rc26/CapturePack-Setup-0.3.4-rc.26.exe`. It is unsigned and gitignored:
