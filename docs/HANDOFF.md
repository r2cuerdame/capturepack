...
**`0.3.4-rc.17`** — a release *candidate* version so a locally built installer can
...
`core/release-rc17/CapturePack-Setup-0.3.4-rc.17.exe`. It is unsigned and gitignored:
