...
**`0.3.4-rc.31`** — a release *candidate* version so a locally built installer can
...
`core/release-rc31c/CapturePack-Setup-0.3.4-rc.31.exe`. It is unsigned and gitignored:
