...
**`0.3.4-rc.8`** — a release *candidate* version so a locally built installer can
...
`core/release-rc8/CapturePack-Setup-0.3.4-rc.8.exe`. It is unsigned and gitignored:
