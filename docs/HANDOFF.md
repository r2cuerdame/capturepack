...
**`0.3.4-rc.7`** — a release *candidate* version so a locally built installer can
...
`core/release-rc7/CapturePack-Setup-0.3.4-rc.7.exe`. It is unsigned and gitignored:
