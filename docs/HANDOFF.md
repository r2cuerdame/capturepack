...
**`0.3.4-rc.9`** — a release *candidate* version so a locally built installer can
...
`core/release-rc9/CapturePack-Setup-0.3.4-rc.9.exe`. It is unsigned and gitignored:
