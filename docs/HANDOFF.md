...
**`0.3.4-rc.15`** — a release *candidate* version so a locally built installer can
...
`core/release-rc15/CapturePack-Setup-0.3.4-rc.15.exe`. It is unsigned and gitignored:
