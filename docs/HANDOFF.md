...
**`0.3.4-rc.27`** — a release *candidate* version so a locally built installer can
...
`core/release-rc27/CapturePack-Setup-0.3.4-rc.27.exe`. It is unsigned and gitignored:
