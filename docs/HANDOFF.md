...
**`0.3.4-rc.24`** — a release *candidate* version so a locally built installer can
...
`core/release-rc24/CapturePack-Setup-0.3.4-rc.24.exe`. It is unsigned and gitignored:
