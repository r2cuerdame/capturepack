...
**`0.3.4-rc.10`** — a release *candidate* version so a locally built installer can
...
`core/release-rc10/CapturePack-Setup-0.3.4-rc.10.exe`. It is unsigned and gitignored:
