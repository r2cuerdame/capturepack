...
**`0.3.4-rc.13`** — a release *candidate* version so a locally built installer can
...
`core/release-rc13/CapturePack-Setup-0.3.4-rc.13.exe`. It is unsigned and gitignored:
