...
Aktuelle öffentliche Windows-Version: **CapturePack 0.4.1**. Die im Pack
...
**0.4.1 ist der aktuelle öffentliche Windows-Download.** CapturePack ist
...
CapturePack `0.4.1` ist die Version der Anwendung. Die `format_version` des Packs
