...
;(function () {
  var DICT = {
    en: {
      ...
      btn_sponsor: '♥ Sponsor',
    release_note: 'Public download: 0.3.5. One process, not two — the watchdog is gone. Captures clean up after themselves on a retention policy you set, and a pin number is yours to type.',
    ...
    ko: {
      ...
      btn_download: '다운로드',
      btn_sponsor: '♥ 후원',
    release_note: '현재 공개 다운로드는 0.3.5입니다. 이제 프로세스는 하나뿐이고 워치독은 사라졌습니다. 캡처는 직접 정한 보관 기간에 따라 스스로 정리되고, 상자 번호는 앱이 아니라 사용자가 직접 입력합니다.',
      badge_foss: '무료 · 오픈소스',
    ...
    ja: {
      ...
      btn_download: 'ダウンロード',
      btn_sponsor: '♥ スポンサー',
    release_note: '現在の公開ダウンロードは0.3.5です。プロセスは2つではなく1つになり、ウォッチドッグは廃止されました。キャプチャは設定した保持期間に従って自動で整理され、ボックスの番号はアプリ任せでなく自分で入力できます。',
    ...
    zh: {
      ...
      btn_download: '下载',
      btn_sponsor: '♥ 赞助',
    release_note: '当前公开下载为 0.3.5。现在只有一个进程，看门狗已移除；捕获会按你设定的保留策略自动清理，方框编号也由你自己输入，不再由应用决定。',
      badge_foss: '免费开源',
    ...
    release_note: 'La descarga pública actual es 0.3.5. Un solo proceso, no dos: el watchdog ha desaparecido. Las capturas se limpian solas según la retención que definas, y el número de cada recuadro lo escribes tú.',
    ...
    release_note: 'Le téléchargement public actuel est la 0.3.5. Un seul processus au lieu de deux : le watchdog a disparu. Les captures se nettoient seules selon la durée de conservation que vous fixez, et vous tapez le numéro d’un cadre.',
    ...
    release_note: 'Der aktuelle öffentliche Download ist 0.3.5. Ein Prozess statt zwei — der Watchdog ist weg. Aufnahmen räumen sich nach Ihrer Aufbewahrungsfrist selbst auf, und die Rahmennummer tippen Sie selbst.',
    ...
    pt: {
      ...
      btn_download: 'Baixar',
      btn_sponsor: '♥ Apoiar',
    release_note: 'O download público atual é 0.3.5. Um processo, não dois — o watchdog foi removido. As capturas se limpam sozinhas conforme a retenção que você define, e o número da caixa é você que digita.',
    ...
    release_note: 'Текущая публичная загрузка — 0.3.5. Приложение работает в одном процессе: watchdog удалён. Старые захваты удаляются автоматически по заданному вами сроку хранения, а номер рамки вы вводите сами.',
