...
;(function () {
  var DICT = {
    en: {
      ...
      btn_sponsor: '♥ Sponsor',
      release_note: 'Unsigned Windows build — SmartScreen may warn. Every release includes SHA256 checksums.',
    ...
    ko: {
      ...
      btn_download: '다운로드',
      btn_sponsor: '♥ 후원',
      release_note: '서명되지 않은 Windows 빌드입니다 — SmartScreen이 경고할 수 있습니다. 모든 릴리스에 SHA256 체크섬이 포함됩니다.',
      badge_foss: '무료 · 오픈소스',
    ...
    ja: {
      ...
      btn_download: 'ダウンロード',
      btn_sponsor: '♥ スポンサー',
      release_note: '署名されていないWindowsビルドです。SmartScreenが警告する場合があります。各リリースにSHA256チェックサムが含まれます。',
    ...
    zh: {
      ...
      btn_download: '下载',
      btn_sponsor: '♥ 赞助',
      release_note: '这是未签名的 Windows 版本，SmartScreen 可能会警告。每个版本都提供 SHA256 校验和。',
      badge_foss: '免费开源',
    ...
    es: {
      ...
      release_note: 'Compilación de Windows sin firmar: SmartScreen puede avisar. Cada versión incluye sumas SHA256.',
    ...
    fr: {
      ...
      release_note: 'Version Windows non signée : SmartScreen peut afficher un avertissement. Chaque version fournit des sommes SHA256.',
    ...
    de: {
      ...
      release_note: 'Nicht signierter Windows-Build — SmartScreen kann warnen. Jede Version enthält SHA256-Prüfsummen.',
    ...
    pt: {
      ...
      btn_download: 'Baixar',
      btn_sponsor: '♥ Apoiar',
      release_note: 'Build do Windows sem assinatura — o SmartScreen pode alertar. Cada versão inclui somas SHA256.',
    ...
    ru: {
      ...
      release_note: 'Сборка Windows не подписана — SmartScreen может показать предупреждение. К каждому выпуску приложены суммы SHA256.',
