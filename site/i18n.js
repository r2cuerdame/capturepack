...
;(function () {
  var DICT = {
    en: {
      ...
      btn_sponsor: '♥ Sponsor',
    release_note: 'Public download: 0.3.4. Object Pick now belongs to the still image, which reads every visible browser window; a video keeps replay, timeline and the boxes you draw.',
    ...
    ko: {
      ...
      btn_download: '다운로드',
      btn_sponsor: '♥ 후원',
    release_note: '현재 공개 다운로드는 0.3.4입니다. 객체 선택은 이제 정지 이미지의 기능이며, 스크린샷은 보이는 모든 브라우저 창의 페이지를 담습니다. 영상에는 리플레이와 타임라인, 직접 그린 상자가 남습니다.',
      badge_foss: '무료 · 오픈소스',
    ...
    ja: {
      ...
      btn_download: 'ダウンロード',
      btn_sponsor: '♥ スポンサー',
    release_note: '現在の公開ダウンロードは0.3.4です。オブジェクト選択は静止画の機能になり、スクリーンショットは見えているすべてのブラウザーウィンドウのページを収めます。動画にはリプレイ、タイムライン、自分で描いたボックスが残ります。',
    ...
    zh: {
      ...
      btn_download: '下载',
      btn_sponsor: '♥ 赞助',
    release_note: '当前公开下载为 0.3.4。对象选择现在属于静止图像，截图会收录每个可见浏览器窗口的页面；视频保留回放、时间线和你手绘的方框。',
      badge_foss: '免费开源',
    ...
    release_note: 'La descarga pública actual es 0.3.4. Object Pick pertenece ahora a la imagen fija, que lee cada ventana de navegador visible; un vídeo conserva repetición, cronología y los recuadros que dibujas.',
    ...
    release_note: 'Le téléchargement public actuel est la 0.3.4. Object Pick appartient désormais à l’image fixe, qui lit chaque fenêtre de navigateur visible ; une vidéo garde relecture, chronologie et les cadres que vous dessinez.',
    ...
    release_note: 'Der aktuelle öffentliche Download ist 0.3.4. Object Pick gehört jetzt zum Standbild, das jedes sichtbare Browserfenster liest; ein Video behält Replay, Zeitleiste und die Rahmen, die Sie zeichnen.',
    ...
    pt: {
      ...
      btn_download: 'Baixar',
      btn_sponsor: '♥ Apoiar',
    release_note: 'O download público atual é 0.3.4. O Object Pick agora pertence à imagem estática, que lê cada janela de navegador visível; um vídeo mantém replay, linha do tempo e as caixas que você desenha.',
    ...
    release_note: 'Текущая публичная загрузка — 0.3.4. Выбор объектов теперь принадлежит снимку экрана, который читает каждое видимое окно браузера; у видео остаются повтор, временная шкала и нарисованные вами рамки.',
