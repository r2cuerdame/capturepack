...
;(function () {
  var DICT = {
    en: {
      ...
      btn_sponsor: '♥ Sponsor',
    release_note: 'Public download: 0.4.6. From History, create a reviewed, still-only Share Copy without originals, videos, or structured capture context.',
    ...
    ko: {
      ...
      btn_download: '다운로드',
      btn_sponsor: '♥ 후원',
    release_note: '현재 공개 다운로드는 0.4.6입니다. 기록에서 검토를 거친 정지 화면 전용 공유 복사본을 만들 수 있으며, 원본·영상·구조화된 캡처 맥락은 포함되지 않습니다.',
      badge_foss: '무료 · 오픈소스',
    ...
    ja: {
      ...
      btn_download: 'ダウンロード',
      btn_sponsor: '♥ スポンサー',
    release_note: '現在の公開ダウンロードは0.4.6です。履歴から、確認済みの静止画だけの共有コピーを作成でき、原本、動画、構造化されたキャプチャコンテキストは含まれません。',
    ...
    zh: {
      ...
      btn_download: '下载',
      btn_sponsor: '♥ 赞助',
    release_note: '当前公开下载为 0.4.6。现在可从历史记录创建经过检查、仅含静态图像的共享副本，其中不包含原始文件、视频或结构化捕获上下文。',
      badge_foss: '免费开源',
    ...
    release_note: 'La descarga pública actual es 0.4.6. Desde el Historial se puede crear una copia para compartir, revisada y solo con imágenes estáticas, sin originales, vídeos ni contexto estructurado de la captura.',
    ...
    release_note: 'Le téléchargement public actuel est la version 0.4.6. Depuis l’historique, créez une copie de partage vérifiée contenant uniquement des images fixes, sans originaux, vidéos ni contexte structuré de capture.',
    ...
    release_note: 'Der aktuelle öffentliche Download ist 0.4.6. Im Verlauf lässt sich eine geprüfte Share Copy nur mit Standbildern erstellen — ohne Originale, Videos oder strukturierten Aufnahmekontext.',
    ...
    pt: {
      ...
      btn_download: 'Baixar',
      btn_sponsor: '♥ Apoiar',
    release_note: 'O download público atual é 0.4.6. No Histórico, crie uma Cópia de Compartilhamento revisada, apenas com imagens estáticas, sem originais, vídeos nem contexto estruturado da captura.',
    ...
    release_note: 'Текущая публичная версия — 0.4.6. Из истории можно создать проверенную копию для отправки только со снимками — без оригиналов, видео и структурированного контекста захвата.',
