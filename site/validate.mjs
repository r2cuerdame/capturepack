...
check(
  'landing names 0.3.5 as the public release',
  html.includes('"softwareVersion": "0.3.5"')
    && html.includes('>v0.3.5</span>')
    && html.includes('Public download: 0.3.5')
...
check(
  'README names 0.3.5 as the public release',
  readme.includes('Current public Windows release: **CapturePack 0.3.5**')
    && readme.includes('**0.3.5 is the current public Windows download.**')
...
console.log('\n0.3.5 release and documentation contract')
check(
  'roadmap preserves history and adds the current baseline',
  roadmap.includes('## Current baseline — 0.3.5')
...
check(
  'handoff records the stable 0.3.5 baton without presenting the sync issue as fixed',
  handoff.includes('# CapturePack handoff — after v0.3.5')
