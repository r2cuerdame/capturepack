...
Versão pública atual para Windows: **CapturePack 0.4.5**. Na versão 0.4.5, o
...
**0.4.5 é o download público atual para Windows.** O CapturePack continua sendo
...
CapturePack `0.4.5` é a versão do aplicativo. O `format_version` do pack evolui
