...
Versão atual para Windows: **CapturePack 0.3.0**
...
0.3.0 é uma versão inicial para Windows. O build ainda não é assinado, então o SmartScreen
pode alertar; cada versão inclui `SHA256SUMS.txt`.
