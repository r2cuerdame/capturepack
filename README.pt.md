...
Versão pública atual para Windows: **CapturePack 0.6.0**. O Histórico cria
...
1. Baixe `CapturePack-Setup-0.6.0.exe` e `SHA256SUMS.txt`.
...
**0.6.0 é o download público atual para Windows.** O CapturePack continua sendo
...
CapturePack `0.6.0` é a versão do aplicativo. O `format_version` do pack evolui
