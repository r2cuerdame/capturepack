...
Versão pública atual para Windows: **CapturePack 0.4.1**. Agora a página
do navegador salva no pack pode ser lida de volta — reabrir uma captura não
devolvia nada — e o que o Object Pick oferece é medido, não presumido.
...
**0.4.1 é o download público atual para Windows.** O CapturePack continua sendo
...
CapturePack `0.4.1` é a versão do aplicativo. O `format_version` do pack evolui
