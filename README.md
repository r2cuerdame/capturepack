...
Current public Windows release: **CapturePack 0.4.1**. A saved pack's browser page
...
**0.4.1 is the current public Windows download.** CapturePack remains an
...
CapturePack `0.4.1` is the application version. Pack `format_version` evolves
