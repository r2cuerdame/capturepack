...
当前公开 Windows 版本：**CapturePack 0.4.2**。保存下来的包，浏览器页面终于能读回来了
...
**0.4.2 是当前公开的 Windows 下载版本。** CapturePack 仍是一个早期阶段的项目，因此
...
CapturePack `0.4.2` 是应用版本号。包的 `format_version` 通过纯追加式的格式变更独立
