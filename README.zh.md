...
当前公开 Windows 版本：**CapturePack 0.6.0**。可从历史记录创建经检查的
...
1. 下载 `CapturePack-Setup-0.6.0.exe` 与 `SHA256SUMS.txt`。
...
**0.6.0 是当前公开的 Windows 下载版本。** CapturePack 仍是一个早期阶段的项目，因此
...
CapturePack `0.6.0` 是应用版本号。包的 `format_version` 通过纯追加式的格式变更独立
